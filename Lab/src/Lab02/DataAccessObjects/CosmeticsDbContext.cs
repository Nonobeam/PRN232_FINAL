...
public partial class CosmeticsDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Cosmetic__19093A2B5D1178BD");
        ...
        {
            entity.HasKey(e => e.CosmeticId).HasName("PK__Cosmetic__98ED527E2A91F6D8");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__SystemAc__349DA586D81DDF3D");

            entity.ToTable("SystemAccount");

            entity.HasIndex(e => e.EmailAddress, "UQ__SystemAc__49A14740CA29D387").IsUnique();
